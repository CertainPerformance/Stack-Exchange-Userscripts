...
// Set the below to true if you want
// If you do, note that voting will *only* occur if you haven't already voted (+ or -) on the post
const downvoteWhenVotingToClose = false;
